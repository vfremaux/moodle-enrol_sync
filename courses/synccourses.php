<?php	   // author - Funck Thibaut
	...
	$url = $CFG->wwwroot.'/enrol/sync/courses/synccourses.php';
	$PAGE->navigation->add(get_string('synchronization', 'enrol_sync'), $CFG->wwwroot.'/enrol/sync/sync.php');
	$PAGE->navigation->add(get_string('coursecheck', 'enrol_sync'));
	$PAGE->set_url($url);
	...
	*/		
	...
	$filenameformatstr = get_string('filenameformatcc', 'enrol_sync');
