...
// Some Regex constants
    ...
    function getdefaultcategory() {
        ...
        ($mysqlresource1=mysql_query('SELECT MIN(`id`) FROM `'.$CFG->prefix.'course_categories`')) or csverror('You have no category table!','uploadcourses.php?sesskey='.$USER->sesskey); 
...
/// Print the form
    print_heading_with_help('Upload Courses','uploadcourse');
