<?php	   // author - Funck Thibaut
	...
	$url = $CFG->wwwroot.'/enrol/sync/courses/checkcourses.php';
	$PAGE->navigation->add(get_string('synchronization', 'enrol_sync'), $CFG->wwwroot.'/enrol/sync/sync.php');
	$PAGE->navigation->add(get_string('coursecheck', 'enrol_sync'), null);
	$PAGE->set_url($url);
	$PAGE->set_context(null);
	$PAGE->set_title("$site->shortname");
	$PAGE->set_heading($site->fullname);
	echo $OUTPUT->header();
	echo $OUTPUT->heading(get_string('checkingcourse', 'enrol_sync'));
	sync_print_remote_tool_portlet('importfile', $CFG->wwwroot.'/enrol/sync/courses/checkcourses.php', 'checkcourse', 'upload');	
	sync_print_local_tool_portlet($CFG->course_fileexistlocation, 'commandfile', 'checkcourses.php');
