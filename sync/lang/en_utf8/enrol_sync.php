...
$string['boxdescription'] =  'Management tool syncs current user and group using txt and csv files called by cron.<br/><br/>
	Simply specify the directories of the files <br/>
	It is also possible to trigger these scripts manually.';
...
$string['coursesgestion'] = 'Course management';
...
$string['enrolsgestion'] = 'Enrol manager';
...
$string['filenameformat'] = '<strong>Filename format:</strong> UC_YYYY-MM-DD_hh-mm.txt';
...
$string['userpicturesfileprefix'] = 'Picture files prefix';
$string['userpicturesmgtmanual'] = 'Manual user pictures update';
$string['userpicturesoverwrite'] = 'If enabled, forces overwrite of existing pictures with new versions';
